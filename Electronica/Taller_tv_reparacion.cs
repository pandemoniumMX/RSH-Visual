...
{
	public class Taller_tv_reparacion : Form
	{
		...
		{
			string query_tabla_equipos = "SELECT * FROM `reparar_tv` WHERE estado='En reparacion' and concat(id_equipo,equipo,marca,modelo,accesorios,falla,comentarios,fecha_ingreso,fecha_entregar,fecha_egreso,servicio,presupuesto,mano_obra,abono,costo_total,estado,puntos,id_folio,id_personal)LIKE '%" + valueToSearch + "%'";
		...
		private void InitializeComponent()
		{
            ...
            // txttipo
            // 
            this.txttipo.Location = new System.Drawing.Point(1160, 41);
        ...
        private void Taller_tv_reparacion_KeyDown(object sender, KeyEventArgs e)
        {
