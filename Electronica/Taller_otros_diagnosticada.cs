...
{
	public class Taller_otros_diagnosticada : Form
	{
		...
		public Taller_otros_diagnosticada()
		{
			InitializeComponent();
		}
		...
		{
			string query_tabla_equipos = "SELECT id_equipo,id_folio, id_personal,equipo, marca, modelo, accesorios, falla, comentarios, fecha_ingreso, fecha_entregar, servicio,ubicacion,presupuesto,mano_obra,abono,restante,costo_total,estado,puntos FROM `reparar_electrodomesticos` WHERE estado='Diagnosticada' and concat(id_equipo,equipo,marca,modelo,accesorios,falla,comentarios,fecha_ingreso,fecha_entregar,fecha_egreso,servicio,presupuesto,mano_obra,abono,costo_total,estado,puntos,id_folio,id_personal)LIKE '%" + valueToSearch + "%'";
		...
		private void InitializeComponent()
		{
            ...
            // txttipo
            // 
            this.txttipo.Location = new System.Drawing.Point(1158, 25);
            ...
            this.KeyDown += new System.Windows.Forms.KeyEventHandler(this.Taller_electrodomesticos_diagnosticada_KeyDown);
        ...
        private void Taller_electrodomesticos_diagnosticada_KeyDown(object sender, KeyEventArgs e)
        {
