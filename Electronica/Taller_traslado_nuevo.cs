...
{
	public class Taller_traslado_nuevo : Form
	{
		...
		public Taller_traslado_nuevo(string qs, string qs1)
		{
			InitializeComponent();
            txtfolio.Text = qs;
		...
		private void button1_Click_1(object sender, EventArgs e)
		{
			...
			else
			{
                ...
                string query1 = "update reparar_tv set ubicacion='Taller con traslado solicitado' where id_equipo = '" + idequipo + "' and id_folio='"+folio+"' ";
                ...
                string query2 = "update reparar_smartphones set ubicacion='Taller con traslado solicitado' where id_equipo = '" + idequipo + "' and id_folio='" + folio + "' ";
                ...
                string query3 = "update reparar_laptops set ubicacion='Taller con traslado solicitado' where id_equipo = '" + idequipo + "' and id_folio='" + folio + "' ";
                ...
                string query4 = "update reparar_audio set ubicacion='Taller con traslado solicitado' where id_equipo = '" + idequipo + "' and id_folio='" + folio + "' ";
                ...
                string query5 = "update reparar_electrodomesticos set ubicacion='Taller con traslado solicitado' where id_equipo = '" + idequipo + "' and id_folio='" + folio + "' ";
		...
		private void InitializeComponent()
		{
            ...
            this.Name = "Taller_traslado_nuevo";
