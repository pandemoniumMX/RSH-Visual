...
{
	public class Taller_laptops_reparacion : Form
	{
		...
		public Taller_laptops_reparacion()
		{
			InitializeComponent();
		}
		...
		{
			string query_tabla_equipos = "SELECT * FROM `reparar_laptops` WHERE estado='En reparacion' and concat(id_equipo,equipo,marca,modelo,accesorios,falla,comentarios,fecha_ingreso,fecha_entregar,fecha_egreso,servicio,presupuesto,mano_obra,abono,costo_total,estado,puntos,id_folio,id_personal)LIKE '%" + valueToSearch + "%'";
		...
		private void InitializeComponent()
		{
            ...
            this.Name = "Taller_laptops_reparacion";
            this.StartPosition = System.Windows.Forms.FormStartPosition.Manual;
            this.Text = "Clientes";
            this.Load += new System.EventHandler(this.Taller_Load);
            this.KeyDown += new System.Windows.Forms.KeyEventHandler(this.Taller_laptops_reparacion_KeyDown);
        ...
        private void Taller_laptops_reparacion_KeyDown(object sender, KeyEventArgs e)
        {
