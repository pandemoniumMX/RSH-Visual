...
{
	public class RecepcionTablets_Cel : Form
	{
		...
		private void gtngenorden_Click(object sender, EventArgs e)
		{
			...
			if (string.IsNullOrWhiteSpace(combofalla.Text))
			{
				MessageBox.Show("Campo falla no asignado");
			}
			...
			else
			{
				...
				string falla = combofalla.SelectedItem.ToString();
				...
				string query_insertar_cel = "insert into reparar_smartphones (equipo, marca, modelo, accesorios, falla, comentarios,fecha_entregar,fecha_egreso,servicio, estado,ubicacion, id_folio) values ('" + equipo + "', '" + marca + "', '" + modelo + "','" + accesorios + "', '" + falla + "', '" + comentarios + "', '" + fecha + "', '" + fecha + "','" + locacion + "','Pendiente','Recepcion', '" + idfolio + "') ";
				...
				try
				{
					...
					MessageBox.Show(equipo + " gregado(a) correctamente");
					conn.Close();
					Close();
				}
				catch (Exception ex)
		...
		private void InitializeComponent()
		{
			...
			combofalla = new System.Windows.Forms.ComboBox();
			...
			label1.TabIndex = 0;
			label1.Text = "Orden de Servicio Smartphone y Tablets";
			...
			txtequipo.TextChanged += new System.EventHandler(txtcelular_TextChanged);
			...
			combofalla.DropDownStyle = System.Windows.Forms.ComboBoxStyle.DropDownList;
			combofalla.FormattingEnabled = true;
			combofalla.Items.AddRange(new object[11]
			{
				"Pantalla rota",
				"No funciona el touch",
				"Pantalla derramada",
				"No carga",
				"Bateria no sirve",
				"Cambio de botones",
				"Se escucha sin video",
				"Liberacion IMEI",
				"Bloqueo cuena Google",
				"Bloqueo cuenta Icloud",
				"Otro (Especificar en comentarios)"
			});
			combofalla.Location = new System.Drawing.Point(67, 105);
			combofalla.Margin = new System.Windows.Forms.Padding(2);
			combofalla.Name = "combofalla";
			combofalla.Size = new System.Drawing.Size(102, 21);
			combofalla.TabIndex = 4;
			combofalla.SelectedIndexChanged += new System.EventHandler(combofalla_SelectedIndexChanged);
			...
			combomarca.Items.AddRange(new object[40]
			{
				"Acer",
				"Acteck",
				"Aiwa",
			...
			combomarca.Location = new System.Drawing.Point(294, 42);
			combomarca.Margin = new System.Windows.Forms.Padding(2);
			combomarca.Name = "combomarca";
			combomarca.Size = new System.Drawing.Size(102, 21);
			...
			comboaccesorios.Location = new System.Drawing.Point(319, 74);
			comboaccesorios.Margin = new System.Windows.Forms.Padding(2);
			comboaccesorios.Name = "comboaccesorios";
			comboaccesorios.Size = new System.Drawing.Size(102, 21);
			...
			gtngenorden.Location = new System.Drawing.Point(659, 265);
			...
			base.Name = "RecepcionTablets_Cel";
