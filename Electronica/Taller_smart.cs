...
{
	public class Taller_smart : Form
	{
		...
		{
			string query_tabla_smartphones = "SELECT * FROM `reparar_smartphones` WHERE concat(id_equipo,equipo,marca,modelo,accesorios,falla,comentarios,fecha_ingreso,fecha_entregar,fecha_egreso,servicio,presupuesto,mano_obra,abono,costo_total,estado,puntos,id_folio,id_personal)LIKE '%" + valueToSearch + "%'";
			MySqlCommand cmd_query_tabla_smartphones = new MySqlCommand(query_tabla_smartphones, conn);
			try
			{
				MySqlDataAdapter tabla = new MySqlDataAdapter();
				tabla.SelectCommand = cmd_query_tabla_smartphones;
		...
		private void InitializeComponent()
		{
			...
			label2.Name = "label2";
			label2.Size = new System.Drawing.Size(371, 24);
			label2.TabIndex = 2;
			...
			TablaEquipos.CellClick += new System.Windows.Forms.DataGridViewCellEventHandler(TablaEquipos_CellClick_1);
			TablaEquipos.CellContentClick += new System.Windows.Forms.DataGridViewCellEventHandler(TablaEquipos_CellClick);
			TablaEquipos.CellContentDoubleClick += new System.Windows.Forms.DataGridViewCellEventHandler(TablaEquipos_CellContentDoubleClick);
			...
			label1.TabIndex = 6;
			label1.Text = "Buscar:";
			txtfolio.Location = new System.Drawing.Point(484, 25);
			...
			txttipo.Location = new System.Drawing.Point(1155, 25);
