...
{
	public class Taller_actualizar : Form
	{
		...
		{
			DialogResult dr = MessageBox.Show("¿Esta seguro que desea signar al tecnico número ?", "Confirmar información", MessageBoxButtons.YesNoCancel, MessageBoxIcon.Asterisk);
			if (dr == DialogResult.Yes)
			{
				...
				{
					MessageBox.Show("Campo estado vacío");
				}
		...
		private void InitializeComponent()
		{
            ...
            this.button6.Location = new System.Drawing.Point(889, 97);
            ...
            this.btncostos.Location = new System.Drawing.Point(697, 97);
