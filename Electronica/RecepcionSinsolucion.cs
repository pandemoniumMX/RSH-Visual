	...
	public class RecepcionSinsolucion : Form
	{
		...
		private void TablaEquipos_CellMouseClick(object sender, DataGridViewCellMouseEventArgs e)
		{
			if (e.RowIndex >= 0)
			{
				...
				RecepcionSinsolucion_vista cl = new RecepcionSinsolucion_vista();
              ...
              //  cl.txt.Text = row.Cells["ubicacion"].Value.ToString();
        ...
        private void RecepcionReparado_KeyDown(object sender, KeyEventArgs e)
        {
