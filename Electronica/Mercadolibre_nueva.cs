...
{
	public class Mercadolibre_nueva : Form
	{
		...
		private ComboBox combopartes;

		public Mercadolibre_nueva()
		{
			InitializeComponent();
		}
		...
		private void btngenerar_Click(object sender, EventArgs e)
		{
			...
			else
			{
				...
				if (dr == DialogResult.Yes && opf.CheckFileExists)
				{
					...
					File.Copy(opf3.FileName, paths + ruta + CorrectFilename7);
					File.Copy(opf4.FileName, paths + ruta + CorrectFilename6);
					File.Copy(opf5.FileName, paths + ruta + CorrectFilename5);
					string query_insertar_televisor = "insert into refacciones_tv (pieza, marcas, modelos, cantidad, almacen, estado,precio, etiqueta_1, etiqueta_2,imagen1,imagen2,imagen3,imagen4,imagen5) values ('" + pieza + "', '" + marcas + "','" + modelos + "', '" + cantidad + "', '" + almacen + "', '" + estado + "', '" + precio + "','" + etiqueta_3 + "','" + etiqueta_2 + "','" + ruta + CorrectFilename9 + "','" + ruta + CorrectFilename8 + "','" + ruta + CorrectFilename7 + "','" + ruta + CorrectFilename6 + "','" + ruta + CorrectFilename5 + "') ";
					...
					try
					{
						...
						MessageBox.Show("Refacción agregada correctamente");
						conn.Close();
						Close();
					}
					catch (Exception ex)
		...
		{
			System.ComponentModel.ComponentResourceManager resources = new System.ComponentModel.ComponentResourceManager(typeof(Electronica.Mercadolibre_nueva));
			...
			btngenerar.Text = "   Registrar Pieza";
			...
			base.ClientSize = new System.Drawing.Size(1082, 607);
