...
{
	public class RecepcionDepositos_abono : Form
	{
		...
		public RecepcionDepositos_abono()
		{
			InitializeComponent();
		}
		...
		{
			string query_tabla_equipos = "SELECT id_cobranza, id_equipo, tipo, estado, cantidad FROM cobranza where estado = 'Pendiente' and tipo ='abono' and concat (id_cobranza, id_equipo, tipo, estado, cantidad) LIKE '%" + valueToSearch + "%'";
