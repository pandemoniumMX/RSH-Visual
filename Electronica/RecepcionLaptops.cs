...
{
	public class RecepcionLaptops : Form
	{
		...
		private void gtngenorden_Click(object sender, EventArgs e)
		{
			...
			else
			{
				...
				string query_insertar_cel = "insert into reparar_laptops (equipo, marca, modelo, accesorios, falla, comentarios,fecha_entregar,fecha_egreso, servicio, estado,ubicacion, id_folio) values ('" + equipo + "', '" + marca + "', '" + modelo + "','" + accesorios + "', '" + falla + "', '" + comentarios + "', '" + fecha + "','" + fecha + "', '" + locacion + "','Pendiente','Recepcion', '" + idfolio + "') ";
		...
		private void InitializeComponent()
		{
			...
			label1.TabIndex = 0;
			label1.Text = "Orden de Servicio Laptops y Computadoras";
			...
			txtidoculto.Location = new System.Drawing.Point(409, 7);
			...
			gtngenorden.Location = new System.Drawing.Point(659, 268);
