...
{
	public class Mercadolibre_ventas_vista : Form
	{
		...
		public Mercadolibre_ventas_vista()
		{
			InitializeComponent();
		}
		...
		public void btngenerar_Click(object sender, EventArgs e)
		{
			...
			else
			{
				...
				if (dr == DialogResult.Yes && opf.CheckFileExists)
				{
					...
					string query_insertar_televisor = "UPDATE ventas_tv set estado='Depositado', idvendedor='" + vendedor + "', fecha_egreso=CURRENT_TIMESTAMP where serie ='" + serie + "'";
