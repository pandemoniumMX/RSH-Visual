...
{
	public class Taller_audio_pendiente : Form
	{
		...
		{
			string query_tabla_equipos = "SELECT * FROM `reparar_audio` WHERE estado='pendiente' and concat(id_equipo,equipo,marca,modelo,accesorios,falla,comentarios,fecha_ingreso,fecha_entregar,fecha_egreso,servicio,presupuesto,mano_obra,abono,costo_total,estado,puntos,id_folio,id_personal)LIKE '%" + valueToSearch + "%'";
		...
		private void InitializeComponent()
		{
            ...
            this.Name = "Taller_audio_pendiente";
            this.StartPosition = System.Windows.Forms.FormStartPosition.Manual;
            this.Text = "Clientes";
            this.Load += new System.EventHandler(this.Taller_Load);
            this.KeyDown += new System.Windows.Forms.KeyEventHandler(this.Taller_audio_pendiente_KeyDown);
        ...
        private void Taller_audio_pendiente_KeyDown(object sender, KeyEventArgs e)
        {
