...
namespace Electronica
{
	public class Taller_tv_diagnosticada : Form
	{
		...
		{
			string query_tabla_equipos = "SELECT id_equipo,id_folio, id_personal, equipo, marca, modelo, accesorios, falla, comentarios, fecha_ingreso, fecha_entregar, servicio,ubicacion,presupuesto,mano_obra,abono,restante,costo_total,estado,puntos FROM `reparar_tv` WHERE estado='Diagnosticada' and concat(id_equipo,equipo,marca,modelo,accesorios,falla,comentarios,fecha_ingreso,fecha_entregar,fecha_egreso,servicio,presupuesto,mano_obra,abono,restante,costo_total,estado,puntos,id_folio,id_personal)LIKE '%" + valueToSearch + "%'";
