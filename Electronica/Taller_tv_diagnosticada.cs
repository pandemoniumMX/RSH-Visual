...
{
	public class Taller_tv_diagnosticada : Form
	{
		...
		public Taller_tv_diagnosticada()
		{
			InitializeComponent();
		}
		...
		{
			string query_tabla_equipos = "SELECT * FROM `reparar_tv` WHERE estado='Diagnosticada' and concat(id_equipo,equipo,marca,modelo,accesorios,falla,comentarios,fecha_ingreso,fecha_entregar,fecha_egreso,servicio,presupuesto,mano_obra,abono,costo_total,estado,puntos,id_folio,id_personal)LIKE '%" + valueToSearch + "%'";
		...
		private void InitializeComponent()
		{
            ...
            this.TablaEquipos.Size = new System.Drawing.Size(1089, 417);
            ...
            // txttipo
            // 
            this.txttipo.Location = new System.Drawing.Point(1203, 45);
            this.txttipo.Name = "txttipo";
            this.txttipo.Size = new System.Drawing.Size(100, 20);
            this.txttipo.TabIndex = 37;
            this.txttipo.Text = "reparar_tv";
            this.txttipo.Visible = false;
            // 
            // Taller_tv_diagnosticada
            // 
            ...
            this.Name = "Taller_tv_diagnosticada";
            this.StartPosition = System.Windows.Forms.FormStartPosition.Manual;
            this.Text = "Taller televisiones revisadas";
            this.Load += new System.EventHandler(this.Taller_Load);
            this.KeyDown += new System.Windows.Forms.KeyEventHandler(this.Taller_tv_diagnosticada_KeyDown);
        ...
        private void Taller_tv_diagnosticada_KeyDown(object sender, KeyEventArgs e)
        {
