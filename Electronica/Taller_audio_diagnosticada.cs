...
{
	public class Taller_audio_diagnosticada : Form
	{
		...
		public Taller_audio_diagnosticada()
		{
			InitializeComponent();
		}
		...
		{
			string query_tabla_equipos = "SELECT * FROM `reparar_audio` WHERE estado='Diagnosticada' and concat(id_equipo,equipo,marca,modelo,accesorios,falla,comentarios,fecha_ingreso,fecha_entregar,fecha_egreso,servicio,presupuesto,mano_obra,abono,costo_total,estado,puntos,id_folio,id_personal)LIKE '%" + valueToSearch + "%'";
		...
		private void InitializeComponent()
		{
            ...
            this.Name = "Taller_audio_diagnosticada";
            this.StartPosition = System.Windows.Forms.FormStartPosition.Manual;
            this.Text = "Clientes";
            this.Load += new System.EventHandler(this.Taller_Load);
            this.KeyDown += new System.Windows.Forms.KeyEventHandler(this.Taller_audio_diagnosticada_KeyDown);
        ...
        private void Taller_audio_diagnosticada_KeyDown(object sender, KeyEventArgs e)
        {
