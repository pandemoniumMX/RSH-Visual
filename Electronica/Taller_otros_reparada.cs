...
namespace Electronica
{
	public class Taller_otros_reparada : Form
	{
		...
		{
			string query_tabla_equipos = "SELECT id_equipo,id_folio, id_personal,equipo, marca, modelo, accesorios, falla, comentarios, fecha_ingreso, fecha_entregar, servicio,ubicacion,presupuesto,mano_obra,abono,restante,costo_total,estado,puntos FROM `reparar_electrodomesticos` WHERE estado='Reparada' and concat(id_equipo,equipo,marca,modelo,accesorios,falla,comentarios,fecha_ingreso,fecha_entregar,fecha_egreso,servicio,presupuesto,mano_obra,abono,costo_total,estado,puntos,id_folio,id_personal)LIKE '%" + valueToSearch + "%'";
		...
		private void InitializeComponent()
		{
            ...
            this.label2.Text = "Buscar otros equipos en Taller reparados";
            // 
            // TablaEquipos
            // 
            ...
            // txtfolio
            // 
            this.txtfolio.Location = new System.Drawing.Point(256, 47);
            ...
            this.Name = "Taller_otros_reparada";
