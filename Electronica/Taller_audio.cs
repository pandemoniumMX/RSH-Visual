...
{
	public class Taller_audio : Form
	{
		...
		{
			string query_tabla_equipos = "SELECT * FROM `reparar_audio` WHERE concat(id_equipo,equipo,marca,modelo,accesorios,falla,comentarios,fecha_ingreso,fecha_entregar,fecha_egreso,servicio,presupuesto,mano_obra,abono,costo_total,estado,puntos,id_folio,id_personal)LIKE '%" + valueToSearch + "%'";
		...
		private void InitializeComponent()
		{
			...
			label2.Name = "label2";
			label2.Size = new System.Drawing.Size(221, 24);
			label2.TabIndex = 2;
			label2.Text = "Buscar audio en Taller";
